...
*/
-- DropForeignKey
ALTER TABLE "BudgetItem" DROP CONSTRAINT "BudgetItem_tenantId_fkey";
...
-- DropForeignKey
ALTER TABLE "PetitCashAssignment" DROP CONSTRAINT "PetitCashAssignment_tenantId_fkey";

-- DropForeignKey
ALTER TABLE "Theme" DROP CONSTRAINT "Theme_tenantId_fkey";
